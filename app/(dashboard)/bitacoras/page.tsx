        ...
        <div className="mx-auto max-w-7xl">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-gray-400">
              ...
              <p className="text-sm mb-4">Crea un tablero y agrega tareas con dificultad y horas para generar bitácoras</p>
              <Button
                onClick={() => router.push("/roadmaps")}
                className="bg-blue-600 hover:bg-blue-700"
              >
                  ...
                  <CardHeader>
                    ...
                    {bitacora.avatar && (
                      <div className="mt-2">
                        ...
                        <p className="text-xs text-gray-400 mt-1">{bitacora.avatar.experience.toFixed(0)} XP</p>
                      </div>
                    )}
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="text-center p-3 bg-gray-900 rounded-lg">
                        ...
                        <p className="text-white font-bold text-lg">{bitacora.avatar?.experience?.toFixed(0) || 0}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
